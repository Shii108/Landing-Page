<template>
  <section id="first-section" class="flex border">
    <div>
      ...
      <div>
        <button class="border cursor-pointer text-sm px-5 py-3">View on Github</button>
        <button class="border cursor-pointer text-sm px-5 py-3">Get Figma file</button>
      </div>
    </div>
    <div>
  ...
  <section id="fourth-section" class="flex border">
    <div class="border flex-1/2">
      ...
      <p class="text-gray-500 font-light text-[20px]">Our rigorous security and compliance standards are at the heart of
        all we do. We work tirelessly to protect you
        and your customers.</p>
      <a href="www.google.com" class="font-medium text-purple-600 block">Explore Legality Guide</a>
      <a href="www.google.com" class="font-medium text-purple-600">Visit the Trust Center</a>
    </div>
    <div class="border-3 border-red-900 grid grid-cols-2 ">
      ...
      <div class="border">
        ...
        <p class="font-light text-gray-500">FTransactions per day</p>
      </div>
    </div>
  </section>


  <section id="fifth-section" class="border bg-[#F9FAFB]">
    <div><img src="/PhQuotesFill (1).png" alt="quotes" class="w-10 m-auto"></div>
    <p class="font-medium text-2xl text-gray-900">"Landwind is just awesome. It contains tons of predesigned components
